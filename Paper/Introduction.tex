...
For the number of copies that a game sells, we will use video game sales chart on http://www.vgchartz.com/ and filter this list to find the games that are released since 2011. The filtered and ordered list on sales in Europe can be found in the section “Sales numbers”. This list will be used during this research.
